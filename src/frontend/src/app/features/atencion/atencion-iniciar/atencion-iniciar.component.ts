          ...
          <div class="max-w-2xl mx-auto space-y-4">
            ...
            <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-5">
              ...
              <div class="flex flex-wrap gap-4">
                ...
                <label class="flex items-center gap-2 cursor-pointer">
                  <input type="checkbox" [checked]="receta().checkCristalesLaboratorio"
                ...
                <label class="flex items-center gap-2 cursor-pointer">
                  <input type="checkbox" [checked]="receta().checkUrgente"
            ...
            <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-5">
              ...
              <div class="overflow-x-auto">
                <table class="w-full text-sm">
                  <thead><tr>
                    <th class="w-24 pb-3 text-left text-xs font-semibold text-gray-400 uppercase tracking-wide pr-3"></th>
                    <th class="pb-3 text-center text-xs font-semibold text-gray-500 uppercase tracking-wide px-2 w-1/3">OD</th>
                    <th class="pb-3 text-center text-xs font-semibold text-gray-500 uppercase tracking-wide px-2 w-1/3">OI</th>
                    <th class="pb-3 text-center text-xs font-semibold text-gray-500 uppercase tracking-wide px-2 w-1/4">DP</th>
                  </tr></thead>
                  <tbody class="divide-y divide-gray-50">
                    <tr>
                      <td class="py-2 pr-3 text-xs font-medium text-gray-500 whitespace-nowrap">Esférico</td>
                      <td class="py-2 px-2"><input type="text" placeholder="+/-0.00" [class]="inputCls" [value]="receta().lejosODEsferico" (input)="setReceta('lejosODEsferico', $any($event.target).value)"/></td>
                      <td class="py-2 px-2"><input type="text" placeholder="+/-0.00" [class]="inputCls" [value]="receta().lejosOIEsferico" (input)="setReceta('lejosOIEsferico', $any($event.target).value)"/></td>
                      <td class="py-2 px-2"><input type="text" placeholder="+/-0.00" [class]="inputCls" [value]="receta().lejosDPEsferico" (input)="setReceta('lejosDPEsferico', $any($event.target).value)"/></td>
                    </tr>
                    <tr>
                      <td class="py-2 pr-3 text-xs font-medium text-gray-500">Cilindro</td>
                      <td class="py-2 px-2"><input type="text" placeholder="+/-0.00" [class]="inputCls" [value]="receta().lejosODCilindro" (input)="setReceta('lejosODCilindro', $any($event.target).value)"/></td>
                      <td class="py-2 px-2"><input type="text" placeholder="+/-0.00" [class]="inputCls" [value]="receta().lejosOICilindro" (input)="setReceta('lejosOICilindro', $any($event.target).value)"/></td>
                      <td class="py-2 px-2 text-center text-gray-300 text-sm">—</td>
                    </tr>
                    <tr>
                      <td class="py-2 pr-3 text-xs font-medium text-gray-500">Eje</td>
                      <td class="py-2 px-2"><input type="text" placeholder="0°" [class]="inputCls" [value]="receta().lejosODEje" (input)="setReceta('lejosODEje', $any($event.target).value)"/></td>
                      <td class="py-2 px-2"><input type="text" placeholder="0°" [class]="inputCls" [value]="receta().lejosOIEje" (input)="setReceta('lejosOIEje', $any($event.target).value)"/></td>
                      <td class="py-2 px-2 text-center text-gray-300 text-sm">—</td>
                    </tr>
                    <tr>
                      <td class="py-2 pr-3 text-xs font-medium text-gray-500">Observación</td>
                      <td class="py-2 px-2"><input type="text" [class]="inputCls" [value]="receta().lejosODObservacion" (input)="setReceta('lejosODObservacion', $any($event.target).value)"/></td>
                      <td class="py-2 px-2"><input type="text" [class]="inputCls" [value]="receta().lejosOIObservacion" (input)="setReceta('lejosOIObservacion', $any($event.target).value)"/></td>
                      <td class="py-2 px-2"><input type="text" [class]="inputCls" [value]="receta().lejosDPObservacion" (input)="setReceta('lejosDPObservacion', $any($event.target).value)"/></td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-5">
              ...
              <div class="overflow-x-auto">
                <table class="w-full text-sm">
                  <thead><tr>
                    <th class="w-24 pb-3 text-left pr-3"></th>
                    <th class="pb-3 text-center text-xs font-semibold text-gray-500 uppercase tracking-wide px-2 w-1/3">OD</th>
                    <th class="pb-3 text-center text-xs font-semibold text-gray-500 uppercase tracking-wide px-2 w-1/3">OI</th>
                    <th class="pb-3 text-center text-xs font-semibold text-gray-500 uppercase tracking-wide px-2 w-1/4">DP</th>
                  </tr></thead>
                  <tbody class="divide-y divide-gray-50">
                    <tr>
                      <td class="py-2 pr-3 text-xs font-medium text-gray-500 whitespace-nowrap">Esférico</td>
                      <td class="py-2 px-2"><input type="text" placeholder="+/-0.00" [class]="inputCls" [value]="receta().cercaODEsferico" (input)="setReceta('cercaODEsferico', $any($event.target).value)"/></td>
                      <td class="py-2 px-2"><input type="text" placeholder="+/-0.00" [class]="inputCls" [value]="receta().cercaOIEsferico" (input)="setReceta('cercaOIEsferico', $any($event.target).value)"/></td>
                      <td class="py-2 px-2"><input type="text" placeholder="+/-0.00" [class]="inputCls" [value]="receta().cercaDPEsferico" (input)="setReceta('cercaDPEsferico', $any($event.target).value)"/></td>
                    </tr>
                    <tr>
                      <td class="py-2 pr-3 text-xs font-medium text-gray-500">Cilindro</td>
                      <td class="py-2 px-2"><input type="text" placeholder="+/-0.00" [class]="inputCls" [value]="receta().cercaODCilindro" (input)="setReceta('cercaODCilindro', $any($event.target).value)"/></td>
                      <td class="py-2 px-2"><input type="text" placeholder="+/-0.00" [class]="inputCls" [value]="receta().cercaOICilindro" (input)="setReceta('cercaOICilindro', $any($event.target).value)"/></td>
                      <td class="py-2 px-2 text-center text-gray-300 text-sm">—</td>
                    </tr>
                    <tr>
                      <td class="py-2 pr-3 text-xs font-medium text-gray-500">Eje</td>
                      <td class="py-2 px-2"><input type="text" placeholder="0°" [class]="inputCls" [value]="receta().cercaODEje" (input)="setReceta('cercaODEje', $any($event.target).value)"/></td>
                      <td class="py-2 px-2"><input type="text" placeholder="0°" [class]="inputCls" [value]="receta().cercaOIEje" (input)="setReceta('cercaOIEje', $any($event.target).value)"/></td>
                      <td class="py-2 px-2 text-center text-gray-300 text-sm">—</td>
                    </tr>
                    <tr>
                      <td class="py-2 pr-3 text-xs font-medium text-gray-500">Observación</td>
                      <td class="py-2 px-2"><input type="text" [class]="inputCls" [value]="receta().cercaODObservacion" (input)="setReceta('cercaODObservacion', $any($event.target).value)"/></td>
                      <td class="py-2 px-2"><input type="text" [class]="inputCls" [value]="receta().cercaOIObservacion" (input)="setReceta('cercaOIObservacion', $any($event.target).value)"/></td>
                      <td class="py-2 px-2"><input type="text" [class]="inputCls" [value]="receta().cercaDPObservacion" (input)="setReceta('cercaDPObservacion', $any($event.target).value)"/></td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-5">
              ...
              <div class="max-w-xs">
                ...
                <input type="text" placeholder="+/-0.00"
                       ...
                       [value]="receta().lejosADDEsfera" (input)="setReceta('lejosADDEsfera', $any($event.target).value)"/>
              </div>
            </div>
