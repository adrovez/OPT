...
public interface IProductoRepository
{
    ...
    Task<Producto?> GetByIdAsync(Guid productoId, Guid tenantId, CancellationToken cancellationToken = default);

    Task<bool> ExisteCodigoInternoAsync(
        string codigo, Guid tenantId, Guid? excludeProductoId = null, CancellationToken cancellationToken = default);
    ...
    Task SoftDeleteAsync(Guid productoId, Guid tenantId, string deletedBy, CancellationToken cancellationToken = default);
}
